...
_G.packer_plugins = {
  ...
  ["startup.nvim"] = {
    ...
    loaded = true,
    path = "/home/gy/.local/share/nvim/site/pack/packer/start/startup.nvim",
  ...
  ["telescope.nvim"] = {
    loaded = true,
    path = "/home/gy/.local/share/nvim/site/pack/packer/start/telescope.nvim",
